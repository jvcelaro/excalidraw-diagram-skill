...
A coding agent skill that generates beautiful and practical Excalidraw diagrams from natural language descriptions. Not just boxes-and-arrows - diagrams that **argue visually**, using a clean ByteByteGo-inspired explainer profile by default.
...
- **ByteByteGo-inspired by default.** Strong headers, colored section panels, dotted flows, flat icons, and concrete teaching examples are defined in `references/bytebygo-style.md`.
